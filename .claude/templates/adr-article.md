...
Use `mcp__youtrack__create_article` with `parentArticle: "DL-A-1"` (the ADR
...
Reference the resulting Article ID (e.g. `DL-A-12`) as explicit text from the
