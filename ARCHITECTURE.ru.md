...
и входящие серверные слушатели. Стадия 0.4 активна и содержит opt-in синтез
Fake IP в резолвере; последующие стадии реализуют остальную целевую форму
...
flowchart LR
    ...
    FakeIP --> Answer[Ответ]
    Reverse --> Answer
    FakePolicy -->|все остальные запросы| Match[Зональный / политический матчер]
